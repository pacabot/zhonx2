...
C_SRCS += \
../pacabot/src/hal/hal_led/hal_led.c 

OBJS += \
./pacabot/src/hal/hal_led/hal_led.o 

C_DEPS += \
./pacabot/src/hal/hal_led/hal_led.d 


# Each subdirectory must supply rules for building sources it contributes
pacabot/src/hal/hal_led/%.o: ../pacabot/src/hal/hal_led/%.c
	@echo 'Building file: $<'
